...
def home():
    ...
    <head>
        ...
        <title>XAU AI Scoring Pro</title>
    </head>
    <body style="font-family:Arial;text-align:center;background:#101010;color:white;">
        ...
        <hr>
        <p>Rule-Based AI | ATR Dynamic | Anti Sideways</p>
    </body>
    </html>
    """
